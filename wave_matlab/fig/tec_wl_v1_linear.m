...
% cp_data = load('tec_-70--60_10.mat').nseq;
sst = cp_data;
...
dj = 0.125/2;    % this will do 4 sub-octaves per octave
s0 = 2*dt;    % this says start at a scale of 6 months
j1 = 6*10/dj;    % this says do 7 powers-of-two with dj sub-octaves each
...
hold on
contour(time,(period),sig95,[-99,1],'y');
hold on
...
plot(log10(global_ws),(period))
hold on
plot(log10(global_signif),(period),'--')
hold off
xlabel('Power (degC^2)')
